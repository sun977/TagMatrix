  ...
  <div class="tagged-data-container">
    ...
    <div class="table-card card-panel">
      ...
      >
        ...
        <el-table-column v-if="!hiddenColumns.includes('TagM_命中主标签')" label="TagM_命中主标签" min-width="160">
          <template #default="scope">
            <div v-if="(scope.row.tagMode === 'mixed' && scope.row.primaryTag) || (scope.row.tagMode === 'single' && scope.row.tags && scope.row.tags.length > 0)">
              <div class="primary-tag-wrapper" style="display: flex; align-items: center;">
                ...
                <el-tooltip v-if="scope.row.isAiIntervened" effect="dark" placement="top">
                  <template #content>
                    <div style="max-width: 300px; line-height: 1.5;">
                      <strong>AI 裁决理由：</strong><br/>
