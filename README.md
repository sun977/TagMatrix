...
![规则配置](.github/assets/规则配置.png)

### 任务管理 (Task Kanban)
控制并记录每一次的批量打标操作，支持细粒度的任务下发、状态实时追踪与“一键安全回退 (Rollback)”。
![任务管理](.github/assets/任务管理.png)
...
![数据中心](.github/assets/数据中心.png)

### 全局设置 (Global Settings)
提供系统级的参数配置，包含 AI 模型配置、高级开发者模式开关与 MDCT 权重调整。

![全局设置](.github/assets/全局设置.png)
...
👉 **[点击阅读详细的《TagMatrix 用户使用手册》](./docs/TagMatrix/USER_MANUAL.md)**
